...
class Test_vectorization():
    ...
    @staticmethod
    @elfi.core.as_vectorized_simulator
    ...
    @staticmethod
    @elfi.core.as_vectorized_summary
    ...
    @staticmethod
    @elfi.core.as_vectorized_discrepancy
    ...
    def test_as_vectorized_simulator(self):
        ret1 = np.array([5])
        ret2 = np.array([6])
        mock_seq = elfi.core.as_vectorized_simulator(MockSequentialSimulator([ret1, ret2]))
    ...
    def test_as_vectorized_summary(self):
        ret1 = np.array([5])
        ret2 = np.array([6])
        mock_seq = elfi.core.as_vectorized_summary(MockSequentialSummary([ret1, ret2]))
    ...
    def test_as_vectorized_discrepancy(self):
        ret1 = np.array([5])
        ret2 = np.array([6])
        mock_seq = elfi.core.as_vectorized_discrepancy(MockSequentialDiscrepancy([ret1, ret2]))

...
class BSL(Sampler):
    ...
    def __init__(self, model, summary_names, observed=None, output_names=None,
                 ...
                 tkde=None, batch_size=1, seed=None,
                 **kwargs):
        ...
        output_names = output_names + summary_names + model.parameter_names  # TODO: check target_name str or list
        # TODO: SAVE SUMMARY NAMES
        ...
        self.tkde = tkde
        self.output_summaries = output_summaries  # TODO? - better logic?
    ...
    def extract_posterior(self):
        ...
        return BslPosterior(observed=self.observed, model=self.model,
                            prior=ModelPrior(self.model), method=self.method,
                            shrinkage=self.shrinkage, penalty=self.penalty,
                            batch_size=self.batch_size,
                            whitening=self.whitening,
                            type_misspec=self.type_misspec, tkde=self.tkde)
        ...
        if self.start_new_chain:
            ...
            while not_in_support:
                ...
                if np.isfinite(self._prior.logpdf(self.prop_state)):
                    ...
                    cov = cov * 1.01  # TODO!: arbitrary, BETTER!

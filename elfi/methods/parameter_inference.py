...
class BayesianOptimization(ParameterInference):
    ...
    def __init__(self,
        ...
        **kwargs
        ...
        self.batches_per_acquisition = batches_per_acquisition or \
            self.max_parallel_batches
    ...
    def update(self, batch, batch_index, vis=None):
        ...
        if vis and self.batches.next_index > self.n_initial_evidence:
            opts = {}
            opts['point_acq'] = {'x': params.ravel(), 'd': batch[self.target_name].ravel()}
